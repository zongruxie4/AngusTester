...
public class StabilityAddDto {
  ...
  @NotNull
  @Schema(description = "Target identifier for stability test indicator configuration", requiredMode = RequiredMode.REQUIRED)
  private Long targetId;

  @NotNull
  @EnumPart(enumClass = CombinedTargetType.class, allowableValues = {"API", "SCENARIO"})
  @Schema(description = "Target type for stability test indicator configuration (API, SCENARIO)", allowableValues = "API,SCENARIO", requiredMode = RequiredMode.REQUIRED)
