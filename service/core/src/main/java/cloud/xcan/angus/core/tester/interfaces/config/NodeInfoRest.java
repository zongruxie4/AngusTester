...
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.AGENT_INSTALL_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.AGENT_PORT_CHECK_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.AGENT_STATUS_CHECK_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.EXEC_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.KILL_RUNNER_PROCESS_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.LIST_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.RUNNER_PROCESS_ENDPOINT;
...
import cloud.xcan.angus.core.tester.interfaces.config.facade.NodeInfoFacade;
