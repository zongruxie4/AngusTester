...
public class ApisCaseAddDto {
  ...
  @NotNull
  @Schema(description = "API protocol specification for communication type definition", example = "http", requiredMode = RequiredMode.REQUIRED)
  private ApisProtocol protocol;

  @NotNull
  @Schema(description = "HTTP method for API request specification", example = "GET", requiredMode = RequiredMode.REQUIRED)
