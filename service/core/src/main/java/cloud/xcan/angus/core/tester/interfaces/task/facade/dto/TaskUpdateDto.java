...
public class TaskUpdateDto {
  ...
  @Schema(example = "A Task", description = "Task display name for identification and organization")
  private String name;
  ...
  @Schema(description = "Primary assignee identifier for task responsibility assignment")
