...
@Tag(name = "IndicatorStabilityInner", description = "Stability Test Indicator Query (Internal) - Internal endpoints for AngusCtrl system to retrieve stability testing indicator.")
@Validated
@RestController
@RequestMapping("/innerapi/v1/indicator")
public class IndicatorStabilityInnerRest {
