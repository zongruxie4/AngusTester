...
@Tag(name = "Task Recycle Bin", description = "Task Recycle Bin Management API - Comprehensive data recovery system for deleted tasks and sprints with restore capabilities, permanent deletion controls, and project-based organization.")
@Validated
@RestController
