...
@Schema(description = "Data transfer object for creating new data analysis tasks with comprehensive configuration")
public class AnalysisAddDto {

  @NotNull
  @Schema(description = "Project ID that the analysis task belongs to", requiredMode = RequiredMode.REQUIRED)
  ...
  @Schema(description = "Flag to include assignee or tester analysis in the results, defaults to true")
