...
public enum ActivityType implements ValueObject<ActivityType> {
  ...
  TASK_STATUS, TASK_ASSIGNEE, TASK_ASSIGNEE_CLEAR, TASK_CONFIRMER, TASK_CONFIRMER_CLEAR, TASK_SUB_SET, TASK_SUB_CANCEL,
  ...
  TAG, TAG_CLEAR, ASSOC_TASK, ASSOC_TASK_CANCEL, ASSOC_CASE, ASSOC_CASE_CANCEL, ASSOC_SCENARIO, ASSOC_SCENARIO_CANCEL,
  START, STOP, GEN_NOW,
  ...
  public String getMessageKeyPrefix() {
    return "xcm.tester.activity.";
  }

  public String getDescMessageKey() {
    return getMessageKeyPrefix() + this.name();
  }

  public String getDetailMessageKey() {
    return getMessageKeyPrefix() + "detail." + this.name();
  }
