...
@Tag(name = "ExecutionSampleInner", description = "Internal Execution Sampling API - Service internal detailed execution sampling data access")
@Validated
@RestController
...
public class ExecSampleInnerRest {
  ...
  @Operation(summary = "Query the score (RT) list of execution sampling", operationId = "exec:sample:score:rt:list:inner")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the throughput list of execution sampling", operationId = "exec:sample:score:throughput:list:inner")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
