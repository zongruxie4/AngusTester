...
public class MockDataGenDto {

  @Schema(description = "Generate data execution script id. Generate a new script when the script ID is empty")
  private Long scriptId;

  @Schema(description = "Project id, it is required when add script")
