 ...
 * <p>
 * This class provides comprehensive functionality for querying and managing functional test
 * indicators, which define performance metrics and thresholds for functional testing. It handles
...
public class IndicatorFuncQueryImpl implements IndicatorFuncQuery {
   ...
   * <p>
   * Retrieves a functional indicator for the specified target and validates its existence. Enriches
   ...
   * <p>
   * Retrieves a functional indicator without existence validation or target enrichment. Used for
