...
public class ScriptAuthRest {
  ...
  @Operation(description = "Add the authorization of script", operationId = "script:auth:add")
  @ApiResponses(value = {
  ...
  @Operation(description = "Replace the authorization of script", operationId = "script:auth:replace")
  @ApiResponses(value = {
  ...
  @Operation(description = "Enable or disable the authorization of script", operationId = "script:auth:enabled")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query authorization status of script", operationId = "script:auth:status")
  @ApiResponses(value = {
  ...
  @Operation(description = "Delete the authorization of script", operationId = "script:auth:delete")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the user authorization permission", operationId = "script:user:auth")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @ResponseStatus(HttpStatus.OK)
  ...
  @Operation(description = "Query the current user authorization permission", operationId = "script:user:auth:current")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @ResponseStatus(HttpStatus.OK)
  ...
  @Operation(description = "Query the current user authorization permission", operationId = "script:user:auth:current:batch")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @ResponseStatus(HttpStatus.OK)
  ...
  @Operation(description = "Check the user authorization permission of script, the administrator permission is included", operationId = "script:auth:check")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the list of script authorization", operationId = "script:auth:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping("/auth")
