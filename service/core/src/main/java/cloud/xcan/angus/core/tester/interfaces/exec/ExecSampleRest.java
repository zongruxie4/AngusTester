...
public class ExecSampleRest {
  ...
  @Operation(summary = "Query the score (RT) list of execution sampling", operationId = "exec:sample:score:rt:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the throughput list of execution sampling", operationId = "exec:sample:score:throughput:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the error content list of execution sampling", operationId = "exec:sample:error:content:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the latest errors counter of execution sampling", operationId = "exec:sample:errors:counter:latest")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the latest upload result progress of execution sampling", operationId = "exec:sample:uploadResultProgress:latest")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the latest extended counter of execution sampling", operationId = "exec:sample:counter:map:latest")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the extended content list of execution sampling", operationId = "exec:sample:content:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
