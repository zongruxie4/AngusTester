...
public class ExecSampleRest {

  @Resource
  private ExecSampleFacade execSampleFacade;

  @Operation(description = "Query the total summary information of the last sampling execution.", operationId = "exec:sample:summary:total")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the score (RT) list of execution sampling.", operationId = "exec:sample:score:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the throughput list of execution sampling.", operationId = "exec:sample:score:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the thread list of execution sampling.", operationId = "exec:sample:thread:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the errors list of execution sampling.", operationId = "exec:sample:error:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the error content list of execution sampling", operationId = "exec:sample:error:content:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the latest errors counter of execution sampling", operationId = "exec:sample:errors:counter:latest")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the latest upload result progress of execution sampling", operationId = "exec:sample:uploadResultProgress:latest")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the latest extended counter of execution sampling", operationId = "exec:sample:counter:map:latest")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the extended content list of execution sampling", operationId = "exec:sample:content:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
