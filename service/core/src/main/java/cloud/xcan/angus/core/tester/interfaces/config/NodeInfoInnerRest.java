...
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.AGENT_INSTALL_DOOR_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.NODE_INFO_DELETE_DOOR_ENDPOINT;
import static cloud.xcan.angus.core.tester.application.cmd.config.NodeInfoCmd.NODE_ONLINE_ENDPOINT_PREFIX;
