...
public class FuncPlanReplaceDto {

  @Schema(description = "Functional test plan identifier for replacement operation", example = "1")
  private Long id;

  @Schema(description = "Project identifier for test plan scope definition", example = "1")
  private Long projectId;

  //@Schema(description = "Plan status", example = "IN_PROGRESS")
  ...
  @Schema(description = "Test case prefix for naming convention", example = "EXAMPLE_")
