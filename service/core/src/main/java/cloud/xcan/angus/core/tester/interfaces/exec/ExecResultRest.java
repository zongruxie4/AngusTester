...
@Tag(name = "ExecResult", description = "User Test Results API - End-user access to test artifacts: services, interfaces, executions, scripts, scenarios")
@Validated
@RestController
@RequestMapping("/api/v1/exec")
public class ExecResultRest {

  @Resource
  private ExecResultFacade execResultFacade;

  @Operation(description = "Query the execution test result.", operationId = "exec:result:detail")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @GetMapping(value = "/{execId}/result")
  public ApiLocaleResult<ExecTestResultDetailVo> execResult(
  ...
  @Operation(description = "Query the apis execution test result by script type.", operationId = "exec:apis:result:byScriptType")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @GetMapping(value = "/apis/{apiId}/{scriptType}/result")
  public ApiLocaleResult<ExecTestResultDetailVo> apisResultByScriptType(
  ...
  @Operation(description = "Query the execution test result of apis.", operationId = "exec:apis:result:all")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping(value = "/apis/{apiId}/result")
  public ApiLocaleResult<ExecTestResultVo> apisResult(
      @Parameter(name = "apiId", description = "Apis id", required = true) @PathVariable("apiId") Long apiId) {
    return ApiLocaleResult.success(execResultFacade.apisResult(apiId));
  }

  @Operation(description = "Query the execution apis test result of services.", operationId = "exec:service:result:info")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the execution apis test result of project.", operationId = "exec:project:apis:result:info")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the scenario execution test result by script type.", operationId = "exec:scenario:result:byScriptType")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @GetMapping(value = "/scenario/{scenarioId}/{scriptType}/result")
  public ApiLocaleResult<ExecTestResultDetailVo> scenarioResultByScriptType(
  ...
  @Operation(description = "Query the execution test result of scenario.", operationId = "exec:scenario:result:all")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping(value = "/scenario/{scenarioId}/result")
  public ApiLocaleResult<ExecTestResultVo> scenarioResult(
      @Parameter(name = "scenarioId", description = "Scenario id", required = true) @PathVariable("scenarioId") Long scenarioId) {
    return ApiLocaleResult.success(execResultFacade.scenarioResult(scenarioId));
  }

  @Operation(description = "Query the execution scenario test result of project", operationId = "exec:project:scenario:result:info")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(description = "Query the execution result of case", operationId = "exec:case:result:detail")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping(value = "/case/{caseId}/result")
  public ApiLocaleResult<ExecTestCaseResultDetailVo> caseResult(
