...
@Tag(name = "ExecutionResult", description = "User Test Results API - End-user access to test artifacts: services, interfaces, executions, scripts, scenarios")
@Validated
@RestController
...
public class ExecResultRest {
  ...
  @Operation(summary = "Query the execution scenario test result of project", operationId = "exec:project:scenario:result:info")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  ...
  @Operation(summary = "Query the execution result of case", operationId = "exec:case:result:detail")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
