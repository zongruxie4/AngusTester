...
@ToString
public class MockServiceStopDto {
  ...
  @Schema(description = "Mock service shutdown command parameters for batch operation management", requiredMode = RequiredMode.REQUIRED)
  private List<StopCmdParam> cmdParams;
