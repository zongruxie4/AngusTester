...
INSERT INTO `app` (`id`, `code`, `name`, `show_name`, `icon`, `type`, `edition_type`, `description`, `auth_ctrl`, `enabled`, `url`, `sequence`, `api_ids`, `version`, `open_stage`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (100010, 'AngusTester', 'AngusTester', 'AngusTester', '', 'CLOUD_APP', 'ENTERPRISE', 'AngusTester企业版', 1, 1, 'http://localhost:8901', 7, '[]', '1.0.0', 'SIGNUP', 'xcan_tp', :TENANT_ID, -1, '2024-01-01 00:00:00', -1, '2024-01-01 00:00:00');
UPDATE `app` SET `created_date` = now(), `modified_date` = now();

-- ----------------------------
-- Table data for app_func
-- ----------------------------
DELETE FROM `app_func` WHERE app_id = 100010;
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101502001, 'Apis', '接口', '接口', -1, '', 'MENU', '', 1, 1, '/apis', 100010, 5, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22',  -1, '2024-07-31 14:58:04');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101517001, 'Config', '配置', '配置', -1, '', 'MENU', '', 1, 1, '/config', 100010, 15, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-03-01 20:33:50');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101506001, 'Data', '数据', '数据', -1, '', 'MENU', '', 1, 1, '/data', 100010, 8, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:58:51');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101508001, 'Execution', '执行', '执行', -1, '', 'MENU', '', 1, 1, '/execution', 100010, 9, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:59:02');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101516001, 'FunctionTesting', '功能测试', '功能', -1, '', 'MENU', '', 1, 1, '/function', 100010, 4, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:51:28');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101501000, 'Kanban', '看板', '看板', -1, '', 'MENU', '', 1, 1, '/kanban', 100010, 2, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:56:25');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101501001, 'Projects', '项目', '项目', -1, 'icon-shenheshibai', 'MENU', '', 1, 1, '/project', 100010, 1, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-06-04 18:49:18', -1, '2024-08-16 08:07:25');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101510001, 'Report', '报告', '报告', -1, '', 'MENU', '', 1, 1, '/report', 100010, 15, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-08-20 18:29:06');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101503001, 'Scenario', '场景', '场景', -1, '', 'MENU', '', 1, 1, '/scenario', 100010, 6, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:58:23');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101507001, 'Script', '脚本', '脚本', -1, '', 'MENU', '', 1, 1, '/script', 100010, 7, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:58:31');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101504001, 'Task', '任务', '任务', -1, '', 'MENU', '', 1, 1, '/task', 100010, 3, '[]',  'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:57:52');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101515001, 'OfficialWebsite', '官网', '官网', -1, '', 'MENU', '', 1, 1, 'https://www.xcan.cloud', 100010, 17, '[]', 'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-04-03 17:55:24');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101512001, 'GlobalSearch', '搜索框', '搜索框', -1, '', 'MENU', '', 1, 1, '/', 100010, 14, '[]', 'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-01-02 11:22:22');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (1000101513001, 'WorkOrder', '工单', '工单', -1, '', 'MENU', '', 1, 1, 'https://wo.xcan.cloud/workorders', 100010, 15, '[]', 'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-04-03 17:54:51');
UPDATE `app_func` SET `created_date` = now(), `modified_date` = now();
...
INSERT INTO `auth_policy` (`id`, `name`, `code`, `enabled`, `type`, `default0`, `grant_stage`, `description`, `app_id`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (129001, '应用管理员', 'ANGUSTESTER_ADMIN', 1, 'PRE_DEFINED', 1, 'SIGNUP_SUCCESS', '拥有“AngusTester”应用所有功能和“应用设置”权限。', 100010, 'xcan_tp', :TENANT_ID, -1, '2024-01-01 00:00:00', -1, '2024-01-01 00:00:00');
INSERT INTO `auth_policy` (`id`, `name`, `code`, `enabled`, `type`, `default0`, `grant_stage`, `description`, `app_id`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (129002, '一般用户', 'ANGUSTESTER_USER', 1, 'PRE_DEFINED', 1, 'SIGNUP_SUCCESS', '拥有“AngusTester”应用所有功能权限，无“应用设置”权限。', 100010, 'xcan_tp', :TENANT_ID, -1, '2024-01-01 00:00:00', -1, '2024-01-01 00:00:00');
INSERT INTO `auth_policy` (`id`, `name`, `code`, `enabled`, `type`, `default0`, `grant_stage`, `description`, `app_id`, `client_id`, `tenant_id`, `created_by`, `created_date`, `modified_by`, `modified_date`) VALUES (129003, '访客', 'ANGUSTESTER_GUEST', 1, 'PRE_DEFINED', 1, 'SIGNUP_SUCCESS', '拥有“AngusTester”应用功能查看权限，无“应用设置”权限。', 100010, 'xcan_tp', :TENANT_ID, -1, '2024-01-01 00:00:00', -1, '2024-01-01 00:00:00');
UPDATE `auth_policy` SET `created_date` = now(), `modified_date` = now();
