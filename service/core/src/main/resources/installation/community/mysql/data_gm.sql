...
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl_flag`, `enabled_flag`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (1000111512001, 'SearchbBar', '搜索框', '搜索框', -1, '', 'MENU', '', 1, 1, '/', 100011, 14, '[]', 'xcan_tp', :tenantId, -1, '2024-01-02 11:22:22', -1, '2024-01-02 11:22:22');
...
-- ----------------------------
INSERT INTO `app_open` (`id`, `app_id`, `app_code`, `app_type`, `edition_type`, `version`, `client_id`, `tenant_id`, `user_id`, `open_date`, `expiration_date`, `expiration_deleted_flag`, `op_client_open_flag`, `created_date`) VALUES (2, 100011, 'AngusTester', 'CLOUD_APP', 'COMMUNITY', '1.0.0', 'xcan_tp', :tenantId, -1, ':appOpenDate', ':appExpirationDate', 0, 0, '2024-01-01 00:00:00');
...
-- ----------------------------
INSERT INTO `auth_policy_org` (`id`, `policy_id`, `policy_type`, `org_id`, `org_type`, `grant_scope`, `open_auth_flag`, `app_id`, `tenant_id`, `default_flag`, `created_by`, `created_date`) VALUES (219427254927626049, 132001, 'PRE_DEFINED', :tenantId, 'TENANT', 'TENANT_SYS_ADMIN', 1, 100011, :tenantId, 0, -1, '2024-03-31 23:51:12');
INSERT INTO `auth_policy_org` (`id`, `policy_id`, `policy_type`, `org_id`, `org_type`, `grant_scope`, `open_auth_flag`, `app_id`, `tenant_id`, `default_flag`, `created_by`, `created_date`) VALUES (219427254927626050, 132002, 'PRE_DEFINED', :tenantId, 'TENANT', 'TENANT_ALL_USER', 0, 100011, :tenantId, 1, -1, '2024-03-31 23:51:12');
-- @formatter:on
