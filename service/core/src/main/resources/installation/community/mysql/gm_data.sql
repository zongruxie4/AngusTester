...
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (1000111516001, 'Function', '用例', '功能', -1, '', 'MENU', '', 1, 1, '/function', 100011, 5, '[]', 'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:22:28');
INSERT INTO `app_func` (`id`, `code`, `name`, `show_name`, `pid`, `icon`, `type`, `description`, `auth_ctrl`, `enabled`, `url`, `app_id`, `sequence`, `api_ids`, `client_id`, `tenant_id`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) VALUES (1000111505001, 'Mock', 'Mock', 'Mock', -1, '', 'MENU', '', 1, 1, '/mockservice', 100011, 10, '[]', 'xcan_tp', :TENANT_ID, -1, '2024-01-02 11:22:22', -1, '2024-07-31 14:20:48');
...
INSERT INTO `web_tag_target` (`id`, `tag_id`, `target_type`, `target_id`, `tenant_id`, `created_by`, `created_date`) VALUES (220404475951581907, 1, 'MENU', 1000111505001, :TENANT_ID, -1, '2024-04-14 20:01:35');
INSERT INTO `web_tag_target` (`id`, `tag_id`, `target_type`, `target_id`, `tenant_id`, `created_by`, `created_date`) VALUES (220404475951581908, 6, 'MENU', 1000111505001, :TENANT_ID, -1, '2024-04-14 20:01:35');
...
INSERT INTO `auth_policy_func` (`id`, `policy_id`, `app_id`, `func_id`, `func_type`, `tenant_id`, `created_by`, `created_date`) VALUES (239132446770074028, 132001, 100011, 1000111505001, 'MENU', :TENANT_ID, -1, '2024-08-16 08:29:17');
...
INSERT INTO `auth_policy_func` (`id`, `policy_id`, `app_id`, `func_id`, `func_type`, `tenant_id`, `created_by`, `created_date`) VALUES (239132446770074246, 132002, 100011, 1000111505001, 'MENU', :TENANT_ID, -1, '2024-08-16 08:38:21');
...
-- ----------------------------
INSERT INTO `auth_policy_org` (`id`, `policy_id`, `policy_type`, `org_id`, `org_type`, `grant_scope`, `open_auth`, `app_id`, `tenant_id`, `default`, `created_by`, `created_date`) VALUES (219427254927626049, 132001, 'PRE_DEFINED', :TENANT_ID, 'TENANT', 'TENANT_SYS_ADMIN', 1, 100011, :TENANT_ID, 0, -1, '2024-03-31 23:51:12');
INSERT INTO `auth_policy_org` (`id`, `policy_id`, `policy_type`, `org_id`, `org_type`, `grant_scope`, `open_auth`, `app_id`, `tenant_id`, `default`, `created_by`, `created_date`) VALUES (219427254927626050, 132002, 'PRE_DEFINED', :TENANT_ID, 'TENANT', 'TENANT_ALL_USER', 0, 100011, :TENANT_ID, 1, -1, '2024-03-31 23:51:12');
-- @formatter:on
