...
public interface IndicatorPerfDoorRemote {
  ...
  @Operation(description = "Query the indicator audit detail of performance", operationId = "indicator:perf:detailOrDefault:inner")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")})
  @GetMapping(value = "/innerapi/v1/indicator/{targetType}/{targetId}/perf/detailOrDefault")
