        ...
        <template #header>
          <div class="w-full flex items-center">
            ...
            <div
              ...
              <span>{{ t('jdbcPlugin.FunctionTestDetailJdbc.assertionStatus.failed') }}</span>
            </div>
            <div
              ...
              <span>{{ t('jdbcPlugin.FunctionTestDetailJdbc.assertionStatus.passed') }}</span>
            </div>
            <div
              ...
              <span>{{ t('jdbcPlugin.FunctionTestDetailJdbc.assertionStatus.ignored') }}</span>
            </div>
            <div
              ...
              style="color:rgba(217, 217, 217, 100%);">
              <span class="inline-block w-3 h-3 mr-1.5 rounded-md" style="background-color:rgba(217, 217, 217, 100%);"></span>
              <span>{{ t('jdbcPlugin.FunctionTestDetailJdbc.assertionStatus.disabled') }}</span>
            </div>
          </div>
        </template>
