...
<template>
  <div class="flex items-center flex-shrink-0 space-x-3">
    ...
    <div class="flex items-center cursor-pointer hover:text-text-link-hover" :title="t('httPlugin.uiConfig.actionsGroup.copy')">
      <Icon
        icon="icon-fuzhi"
        class="text-3.5"
        @click="click('clone')" />
    ...
    <div class="flex items-center cursor-pointer hover:text-text-link-hover" :title="t('httPlugin.uiConfig.actionsGroup.delete')">
      <Icon
        icon="icon-qingchu"
        class="text-3.5"
        @click="click('delete')" />
