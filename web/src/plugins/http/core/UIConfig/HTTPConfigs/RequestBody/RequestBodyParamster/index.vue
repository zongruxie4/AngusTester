...
import { computed, watch, ref, onMounted, watchEffect, nextTick } from 'vue';
  ...
  <div class="space-y-3 relative">
    <div
      ...
      <Input
        ...
        :placeholder="t('httpPlugin.uiConfig.httpConfigs.requestBodyConfig.namePlaceholder')"
        trim
      ...
      <Select
        ...
        class="w-25"
        :placeholder="t('httpPlugin.uiConfig.httpConfigs.requestBodyConfig.typePlaceholder')"
      ...
      <div
        ...
        <Upload
          ...
          <Button
            ...
            <span>{{ t('httpPlugin.uiConfig.httpConfigs.requestBodyConfig.filePlaceholder') }}</span>
          </Button>
        </Upload>
      ...
      <Input
        ...
        :placeholder="t('httpPlugin.uiConfig.httpConfigs.requestBodyConfig.valuePlaceholder')"
        trim
        class="flex-1"
        :maxlength="4096"
