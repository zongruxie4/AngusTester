  ...
  <Collapse
    ...
    <CollapsePanel
        ...
        <div class="w-full flex items-center px-3 py-2.5 cursor-pointer" @click="arrowChange(!arrowOpen)">
          ...
          <div class="flex-1 justify-end flex items-center mr-3">
            <template v-if="showBasicInfo">
              <div class="mr-5">
                <span class="mr-0.5">{{ t('jmsPlugin.functionTestDetailJms.statusCode') }}<Colon /></span>
              ...
              <div class="mr-5">
                <span class="mr-0.5">{{ t('jmsPlugin.functionTestDetailJms.size') }}<Colon /></span>
      ...
      <Tabs
        ...
        <TabPane key="timeline" :tab="t('jmsPlugin.functionTestDetailJms.tabs.timeline')">
          <TimeLine :value="httpContent?.content?.response?.timeline" />
        </TabPane>
        <TabPane key="assertions" :tab="t('jmsPlugin.functionTestDetailJms.tabs.assertions')">
          <Alert
