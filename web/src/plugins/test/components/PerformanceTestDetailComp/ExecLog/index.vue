...
const downloadLog = (type:'scheduling' | 'exec') => {
  ...
  a.href = url;
  a.download = type === 'exec' ? t('ftpPlugin.performanceTestDetail.execLog.execLog.downloadFileName') : t('ftpPlugin.performanceTestDetail.execLog.downloadFileName.scheduling');
