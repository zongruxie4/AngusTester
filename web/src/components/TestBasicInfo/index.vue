...
const GridColumns = computed(() => {
  if (props.value?.scriptType?.value === 'MOCK_DATA') {
    return [
      ...
      [{ dataIndex: 'plugin', label: t('common.plugin') }, { dataIndex: 'createdByName', label: t('xcan_testBasicInfo.createdByName') }, { dataIndex: 'modifiedByName', label: t('xcan_testBasicInfo.modifiedByName') }],
  ...
  if (props.hasIgnoreAssertions) {
    return [
      ...
      [{ dataIndex: 'scriptName', label: t('common.priority') }, { dataIndex: 'createdByName', label: t('xcan_testBasicInfo.createdByName') }],
