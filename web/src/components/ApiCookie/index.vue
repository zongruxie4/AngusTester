...
import { Icon, Input, SelectSchema, Select, notification, JsonContent, SimpleEditableSelect } from '@xcan-angus/vue-ui';
...
// 设为变量
const setToVariable = async (data: ParamsItem): Promise<void> => {
      ...
      <div
        ...
        <template v-if="!props.viewType">
          <Button
            ...
            type="primary"
            size="small"
            :disabled="!item.name || setVariableLoading[item.name] || props.viewType"
