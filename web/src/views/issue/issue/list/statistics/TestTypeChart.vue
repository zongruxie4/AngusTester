...
const chartDomId = utils.uuid('test-type-pie');

let chartInstance: echarts.ECharts;

/**
 * Chart color palette for different test types with transparency
 */
const CHART_COLORS = [
  'rgba(82,196,26,70%)', // Green for functional tests
  'rgba(45,142,255,70%)', // Blue for performance tests
  'rgba(255,185,37,70%)' // Orange for stability tests
];

/**
 * ECharts configuration options for the test type pie chart
 */
 ...
 * Each test type is mapped to a data point with its corresponding count.
 */
