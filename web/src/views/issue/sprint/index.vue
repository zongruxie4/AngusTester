 ...
 */
const SprintList = defineAsyncComponent(() => import('@/views/issue/sprint/list/index.vue'));
const SprintDetail = defineAsyncComponent(() => import('@/views/issue/sprint/detail/index.vue'));
const SprintEdit = defineAsyncComponent(() => import('@/views/issue/sprint/edit/index.vue'));
