...
const projectTypeTipConfig = {
  AGILE: ['核心特点：Scrum框架支持 • 迭代增量交付 • 用户需求驱动。', '适用场景：敏捷开发团队快速迭代产品。'],
  GENERAL: ['核心特点：工作分解结构 • 甘特图进度管理 • 资源依赖可视化。', '适用场景：传统研发团队跨部门协作项目。'],
  TESTING: ['核心特点：测试计划定制 • 多类型测试集成 • 缺陷跟踪闭环。', '适用场景：质量保障团队专项测试项目。']
};
