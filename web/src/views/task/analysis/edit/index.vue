...
const templateDescOpt = ref<{value: string, description: string}[]>([]);
const loadDescOpt = () => {
  const data = enumUtils.enumToMessages('AnalysisTaskTemplateDesc');
...
const analysisTimeRangeOpt = ref<{description: string, value:string}[]>([]);
