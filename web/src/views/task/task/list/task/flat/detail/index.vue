...
const Activity = defineAsyncComponent(() => import('@/views/task/task/list/task/flat/detail/Activity.vue'));
const Comment = defineAsyncComponent(() => import('@/views/task/task/list/task/flat/detail/Comment.vue'));
const SubTask = defineAsyncComponent(() => import('@/views/task/task/list/task/flat/detail/SubTask.vue'));
