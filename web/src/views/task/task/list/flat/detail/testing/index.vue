 ...
 */
const ExecutionResult = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/testing/ExecResult.vue'));

/**
 * Lazy-loaded component for displaying test results
 */
const TestResult = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/testing/TestResult.vue'));
