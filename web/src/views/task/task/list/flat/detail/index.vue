...
// Async Components
const BasicInfo = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/info/index.vue'));
const TestInfo = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/testing/index.vue'));
const Remark = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/Remark.vue'));
const Activity = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/Activity.vue'));
const Comment = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/Comment.vue'));
const SubTask = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/SubTask.vue'));
const SplitTask = defineAsyncComponent(() => import('@/views/task/backlog/SplitTask.vue'));
const AssocCaseTab = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/AssocCase.vue'));
const AssocTaskTab = defineAsyncComponent(() => import('@/views/task/task/list/flat/detail/AssocTask.vue'));
  ...
  <Spin
    ...
    <Tabs
      ...
      <TabPane key="assocRequirements">
        <template #tab>
          <div class="inline-flex">
            <span>{{ t('task.detail.assocRequirementTab.title') }}</span>
        ...
        <AssocTaskTab
          ...
          :dataSource="currentTaskInfo?.refTaskInfos || []"
          :taskId="props.id"
          :title="t('task.detail.assocRequirementTab.title')"
          :tips="t('task.detail.assocRequirementTab.tips')"
      ...
      <TabPane key="assocStory">
        <template #tab>
          <div class="inline-flex">
            <span>{{ t('task.detail.assocStoryTab.title') }}</span>
        ...
        <AssocTaskTab
          ...
          :dataSource="currentTaskInfo?.refTaskInfos || []"
          :taskId="props.id"
          :title="t('task.detail.assocStoryTab.title')"
          :tips="t('task.detail.assocStoryTab.tips')"
      ...
      <TabPane key="assocBug">
        <template #tab>
          <div class="inline-flex">
            <span>{{ t('task.detail.assocBugTab.title') }}</span>
        ...
        <AssocTaskTab
          ...
          :dataSource="currentTaskInfo?.refTaskInfos || []"
          :taskId="props.id"
          :title="t('task.detail.assocBugTab.title')"
          :tips="t('task.detail.assocBugTab.tips')"
      ...
      <TabPane key="assocCase">
        <template #tab>
          <div class="inline-flex">
            <span>{{ t('task.detail.assocCaseTab.title') }}</span>
      ...
      <TabPane key="assocApiTest">
        <template #tab>
          <div class="inline-flex">
            <span>{{ t('task.detail.assocApiTestTab.title') }}</span>
        ...
        <AssocTaskTab
          ...
          :dataSource="currentTaskInfo?.refTaskInfos || []"
          :taskId="props.id"
          :title="t('task.detail.assocApiTestTab.title')"
          :tips="t('task.detail.assocApiTestTab.tips')"
      ...
      <TabPane key="assocScenarioTest">
        <template #tab>
          <div class="inline-flex">
            <span>{{ t('task.detail.assocScenarioTestTab.title') }}</span>
        ...
        <AssocTaskTab
          ...
          :dataSource="currentTaskInfo?.refTaskInfos || []"
          :taskId="props.id"
          :title="t('task.detail.assocScenarioTestTab.title')"
          :tips="t('task.detail.assocScenarioTestTab.tips')"
