        ...
        <div class="px-4 py-3 bg-theme-bg-subtle/30 border-t border-theme-border-subtle">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-16">
              ...
              <div class="flex items-center space-x-2">
                <div class="flex flex-col">
                  <span class="text-xs text-theme-sub-content">{{ t('common.participants') }}</span>
                  <span class="text-sm font-medium text-theme-content">
                ...
                <div class="flex -space-x-1">
                  <template v-if="item.participants?.length">
                    ...
                    <Popover
                      ...
                      internal>
                      <template #title>
                        <span class="text-sm font-medium">{{ t('common.participants') }} ({{ item.participants.length }})</span>
                      </template>
                      <template #content>
