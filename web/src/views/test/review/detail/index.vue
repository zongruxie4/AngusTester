...
const SelectCaseModal = defineAsyncComponent(() => import('@/views/test/review/edit/SelectCaseModal.vue'));
const ReviewForm = defineAsyncComponent(() => import('@/views/test/review/detail/ReviewForm.vue'));
