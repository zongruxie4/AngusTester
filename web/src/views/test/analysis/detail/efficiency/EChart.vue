...
const completedEChartConfig = {
  title: {
    text: t('testAnalysis.detail.handlingEfficiency.chartLabels.completedRate'),
    left: '35%',
    bottom: '6%',
    textAlign: 'center',
    textStyle: {
  ...
  series: [
    {
      ...
      data: [
        {
          name: t('testAnalysis.detail.handlingEfficiency.chartLabels.uncompletedCount'),
          value: 0,
          itemStyle: {
            color: '#ff7875'
          }
        ...
        {
          name: t('testAnalysis.detail.handlingEfficiency.chartLabels.completedCount'),
          value: 0,
          itemStyle: {
            color: '#52c41a'
          }
...
const oneTimePassedEChartConfig = JSON.parse(JSON.stringify({
  ...
  title: {
    ...
    text: t('testAnalysis.detail.handlingEfficiency.chartTitles.oneTimeCompletedRate'),
    left: '35%',
    bottom: '6%'
  },
  legend: {
...
const twoTimePassedEChartConfig = JSON.parse(JSON.stringify({
  ...
  title: {
    ...
    text: t('testAnalysis.detail.handlingEfficiency.chartTitles.twoTimeCompletedRate'),
    left: '35%',
    bottom: '6%'
  },
  legend: {
