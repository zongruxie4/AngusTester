...
import { AnalysisInfo } from '@/views/test/analysis/types';
import Introduce from '@/views/test/analysis/list/Introduce.vue';
import SearchPanel from '@/views/test/analysis/list/SearchPanel.vue';

// Async components
const TemplateSelectList = defineAsyncComponent(() => import('@/views/test/analysis/list/TemplateSelect.vue'));
