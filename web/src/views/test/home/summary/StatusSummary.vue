...
const Plan = defineAsyncComponent(() => import('@/views/test/home/summary/PlanCount.vue'));
const Case = defineAsyncComponent(() => import('@/views/test/home/summary/CaseCount.vue'));
const Review = defineAsyncComponent(() => import('@/views/test/home/summary/ReviewCount.vue'));
