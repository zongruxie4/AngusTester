...
const setCpuChartData = () => {
  ...
  const dataType = [t('reportPreview.execPerf.sampling.testDetail.nodeResource.cpuIdle'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.cpuSystem'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.cpuUser'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.cpuIo'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.cpuOther'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.cpuTotal')];
...
const setNetworkChartData = () => {
  ...
  const dataType = [t('reportPreview.execPerf.sampling.testDetail.nodeResource.rxBytes'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.rxBytesRate'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.rxErrors'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.txBytes'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.txBytesRate')];
  const seriesData = dataType.map((type, idx) => {
    return {
      ...getDefaultLineConfig(idx),
      name: type
...
const setMemoryChartData = () => {
  ...
  const dataType = [t('reportPreview.execPerf.sampling.testDetail.nodeResource.free'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.used'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.freePercent'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.usedPercent'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.actualFree'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.actualUsed'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.actualFreePercent'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.actualUsedPercent'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.swapFree'), t('reportPreview.execPerf.sampling.testDetail.nodeResource.swapUsed')];
...
<template>
  ...
  <div v-else class="flex flex-col justify-between">
    <div class="mt-2.5">
      <div v-if="!times.length && memoryloaded">{{ t('common.none') }}</div>
      <div
        v-show="times.length || !memoryloaded"
        ref="echartRef"
