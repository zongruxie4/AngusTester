...
const columns = computed(() => [
  ...
  [
    ...
    {
      dataIndex: 'resultDetailVoMap',
      name: t('reportPreview.apis.testResult.fields.functionalTestFailureReason'),
      customRender: (text) => {
  ...
  [
    {
      dataIndex: 'resultDetailVoMap',
      name: t('reportPreview.apis.testResult.fields.performanceTestFailureReason'),
      customRender: (text) => {
  ...
  [
    ...
    {
      dataIndex: 'resultDetailVoMap',
      name: t('reportPreview.apis.testResult.fields.stabilityTestFailureReason'),
      customRender: (text) => {
...
<template>
  <div>
    <h1 class="text-theme-title font-medium mb-3.5">
      <span id="a2" class="text-4 text-theme-title font-medium">{{ t('reportPreview.serial.2') }}<em class="inline-block w-0.25"></em>{{ t('reportPreview.apis.testResult.title') }}</span>
    </h1>
