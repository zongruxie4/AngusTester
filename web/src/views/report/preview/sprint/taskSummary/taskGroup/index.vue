...
const taskStatusOption = {
  ...
  yAxis: {
    ...
    splitLine: { show: false },
    axisLine: { show: false },
    data: [t('reportPreview.sprint.taskSummary.groupStats.statuses.cancelled'), t('reportPreview.sprint.taskSummary.groupStats.statuses.completed'), t('reportPreview.sprint.taskSummary.groupStats.statuses.pendingConfirm'), t('reportPreview.sprint.taskSummary.groupStats.statuses.processing'), t('reportPreview.sprint.taskSummary.groupStats.statuses.pending')]
  },
  series: [
    {
      type: 'bar',
  ...
  series: [
    {
      ...
      data: [
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.priorities.highest'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.priorities.high'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.priorities.medium'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.priorities.low'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.priorities.lowest'),
          value: 0,
          itemStyle: {
  ...
  series: [
    {
      ...
      data: [
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.taskTypes.bug'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.taskTypes.task'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.taskTypes.story'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.taskTypes.requirement'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.taskTypes.apiTest'),
          value: 0,
          itemStyle: {
        ...
        {
          name: t('reportPreview.sprint.taskSummary.groupStats.taskTypes.scenarioTest'),
          value: 0,
          itemStyle: {
...
onMounted(() => {
  watch(() => props.dataSource, newValue => {
    const totalStatusOverview = newValue?.content?.tasks?.totalStatusOverview;
    ...
    const totalPriorityOverview = newValue?.content?.tasks?.totalPriorityOverview;
    ...
    const totalTypeOverview = newValue?.content?.tasks?.totalTypeOverview;
...
<template>
  <div>
    <h1 class="text-theme-title font-medium mb-3">
      <span class="text-3 text-theme-title font-medium">{{ t('reportPreview.sprint.taskSummary.groupStats.byStatus') }}</span>
    </h1>
    <div ref="taskStatusRef" class="flex-1 h-50 w-120 mb-7">
    </div>

    <h1 class="text-theme-title font-medium mb-3">
      <span class="text-3 text-theme-title font-medium">{{ t('reportPreview.sprint.taskSummary.groupStats.byPriority') }}</span>
    </h1>
