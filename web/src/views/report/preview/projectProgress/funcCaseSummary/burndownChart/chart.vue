...
type Props = {
  title:string;
  dataSource: ReportContent['content']['cases']['burnDownCharts']['NUM'];
}
...
const echartOption = {
  ...
  series: [
    {
      name: t('reportPreview.projectProgress.funcCaseSummary.burndownChart.remaining'),
      data: [],
      type: 'line',
      itemStyle: {
    ...
    {
      name: t('reportPreview.projectProgress.funcCaseSummary.burndownChart.expected'),
      data: [],
      type: 'line',
      smooth: true,
      itemStyle: {
