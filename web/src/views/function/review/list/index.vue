...
const SearchPanel = defineAsyncComponent(() => import('@/views/function/review/list/SearchPanel.vue'));
const List = defineAsyncComponent(() => import('@/views/function/review/list/List.vue'));
