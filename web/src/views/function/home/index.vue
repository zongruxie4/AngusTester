...
const MyCases = defineAsyncComponent(() => import('@/views/function/home/Added.vue'));
const CreateByMeSummary = defineAsyncComponent(() => import('@/views/function/home/summary/CreationSummary.vue'));
