    ...
    <div class="space-y-2.5">
      ...
      <div class="flex items-start space-x-5">
        <div class="w-1/2 flex items-start">
          <div class="w-18 flex items-center justify-end whitespace-nowrap flex-shrink-0 text-right">
            <span class="font-semibold text-black">{{ t('functionPlan.planDetail.basicInfo.owner') }}</span>
            <Colon class="w-1" />
          </div>
      ...
      <div class="flex items-start space-x-5">
        <div class="w-1/2 flex items-center">
          <div class="w-18 flex items-center justify-end whitespace-nowrap flex-shrink-0 text-right mr-1.5">
            <span class="font-semibold text-black">{{ t('functionPlan.planDetail.basicInfo.progress') }}</span>
            <Colon class="w-1" />
          </div>
      ...
      <div class="flex items-start">
        <div style="width:calc(50% - 10px);" class="flex items-start">
          <div class="w-18 flex items-center justify-end whitespace-nowrap flex-shrink-0 text-right">
            <span class="font-semibold text-black">{{ t('functionPlan.planDetail.basicInfo.attachments') }}</span>
            <Colon class="w-1" />
          </div>
