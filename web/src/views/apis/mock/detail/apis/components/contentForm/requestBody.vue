...
const PureFormInput = defineAsyncComponent(() => import('@/views/apis/mock/detail/apis/components/pureFormInput/index.vue'));
const CodeEditor = defineAsyncComponent(() => import('@/views/apis/mock/detail/apis/components/codeEditor/index.vue'));
...
const language = ref<Languge>('json');
