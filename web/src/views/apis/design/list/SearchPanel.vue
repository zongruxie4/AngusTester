...
const searchPanelOptions: any[] = [
  ...
  },
  {
    ...
    placeholder: [
      t('design.home.searchPanel.data_placeholder1'),
      t('design.home.searchPanel.data_placeholder2')
    ],
    showTime: true
  }
];

// Quick search configurations (audit/time)
...
const handleSearchChange = (data: SearchCriteria[], _headers?: { [key: string]: string }, key?: string) => {
  // Synchronize with quick search when associated fields change
  if (key === 'createdBy') {
