...
const UnarchivedEditVue = defineAsyncComponent(() => import('@/views/apis/services/apiHttp/sliderComp/unarchivedEdit/index.vue'));
const InfoEditVue = defineAsyncComponent(() => import('@/views/apis/services/apiHttp/sliderComp/infoEdit/index.vue'));
...
const AgentVue = defineAsyncComponent(() => import('@/views/apis/services/components/agent/index.vue'));
const CodeSnippetVue = defineAsyncComponent(() => import('@/views/apis/services/components/codeSnippet/index.vue'));

const ApiSetting = defineAsyncComponent(() => import('@/views/apis/services/apiHttp/setting/index.vue'));
const ServerPath = defineAsyncComponent(() => import('@/views/apis/services/apiHttp/serverPath/index.vue'));
const Toolbar = defineAsyncComponent(() => import('@/components/layout/toolbar/index.vue'));
const ResponseError = defineAsyncComponent(() => import('@/views/apis/services/apiHttp/responseError/index.vue'));
