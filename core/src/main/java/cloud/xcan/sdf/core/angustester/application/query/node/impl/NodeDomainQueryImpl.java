...
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.DOMAIN_NAME_REPEATED_T;
...
import cloud.xcan.sdf.core.angustester.domain.node.dns.DomainDnsNum;
