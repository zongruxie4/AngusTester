...
import static cloud.xcan.sdf.core.angustester.application.converter.MockApisConverter.toAssocMockApi;
import static cloud.xcan.sdf.core.angustester.application.converter.MockApisConverter.toAssocMockApisResponse;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.MESSAGE_MATCH_STATUS_AND_MEDIATYPE_RESPONSE_NAME;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.MESSAGE_MATCH_STATUS_RESPONSE_NAME;
...
import cloud.xcan.sdf.api.angusctrl.mockservice.dto.MockServiceApisDeleteDto;
...
public class MockServiceConverter {
  ...
  public static StartCmdParam toStartMockServiceCmdParam(MockService service, Node node,
    ...
    cmdParam.setServiceId(service.getId()).setDeviceId(service.getNodeId())
        .setTesterApisServerUrl(mockTesterApisServerUrl)
  ...
  public static String getMockResponseBodyString(Entry<String, MediaType> mediaTypeEntry,
    ...
    try {
      ...
      throw CommProtocolException.of(ExceptionUtils.getMessage(e));
    }
    return body;
  }
