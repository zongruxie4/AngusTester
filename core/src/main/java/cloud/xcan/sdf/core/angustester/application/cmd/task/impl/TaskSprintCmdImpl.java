...
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.TASK_SPRINT_STATUS_MISMATCH_T;
...
import static cloud.xcan.sdf.core.angustester.domain.task.sprint.TaskSprintStatus.BLOCKED;
import static cloud.xcan.sdf.core.angustester.domain.task.sprint.TaskSprintStatus.COMPLETED;
import static cloud.xcan.sdf.core.angustester.domain.task.sprint.TaskSprintStatus.IN_PROGRESS;
...
import cloud.xcan.sdf.core.angustester.application.converter.TaskSprintConverter;
  ...
  public void delete(Long id) {
    new BizTemplate<Void>() {
      ...
      protected Void process() {
        ...
        // Logic delete
        sprint0.setDeletedFlag(true).setDeletedBy(getUserId()).setDeletedDate(LocalDateTime.now());
