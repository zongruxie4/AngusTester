...
import static cloud.xcan.sdf.core.angustester.application.converter.KanbanEfficiencyTaskConverter.assembleFailure;
import static cloud.xcan.sdf.core.angustester.application.converter.KanbanEfficiencyTaskConverter.assembleLeadTime;
import static cloud.xcan.sdf.core.angustester.application.converter.KanbanEfficiencyTaskConverter.assembleUnplanned;
...
import cloud.xcan.sdf.core.angustester.domain.kanban.CtoTaskAssigneeOverview;
...
public class KanbanCtoTaskConverter {
  ...
  public static @NotNull OverdueAssessmentCount assembleOverdueAssessmentCount0(
    ...
    double overdueWorkload = tasks.stream()
        .filter(x -> nonNull(x.getOverdueFlag()) && x.getOverdueFlag() && !x.getStatus()
