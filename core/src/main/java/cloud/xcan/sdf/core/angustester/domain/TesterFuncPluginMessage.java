...
public interface TesterFuncPluginMessage {
  ...
  String FUNC_PLAN_NO_AUTH = "xcm.altester.func.plan.no.auth.t";

  /*Plan*/
  /*<******************Plan(ATF031 ~ ATF040)******************>*/
  String FUNC_PLAN_NAME_REPEATED_T = "xcm.altester.func.plan.name.repeated.t";
  //String FUNC_PLAN_DATE_RANGE_ERROR_T = "xcm.altester.func.plan.date.range.error.t";
  String PLAN_STATUS_MISMATCH_T = "xcm.altester.func.plan.status.mismatch.t";
  String PLAN_REVIEW_NOT_ENABLED_CODE = "ATF031";
  String PLAN_REVIEW_NOT_ENABLED = "xcm.altester.func.plan.review.not.enabled";
  String PLAN_NOT_STARTED_CODE = "ATF032";
  String PLAN_NOT_STARTED = "xcm.altester.func.plan.not.started";
  String PLAN_CASE_NOT_COMPLETED = "xcm.altester.func.plan.case.not.completed";

  /*Review*/
  /*<******************Review(ATF041 ~ ATF050)******************>*/
  String FUNC_REVIEW_NAME_REPEATED_T = "xcm.altester.func.review.name.repeated.t";
  String REVIEW_STATUS_MISMATCH_T = "xcm.altester.func.review.status.mismatch.t";
  String REVIEW_CANNOT_END = "xcm.altester.func.review.cannot.end";
  String REVIEW_NOT_STARTED_CODE = "ATF052";
  String REVIEW_NOT_STARTED = "xcm.altester.func.review.not.started";

  /*Case*/
  /*<******************Case(ATF051 ~ ATF060)******************>*/
  String CASE_NAME_REPEATED_T = "xcm.altester.case.name.repeated.t";
  String CASE_DEADLINE_GREATER_PLAN_T = "xcm.altester.case.deadline.greater.plan.t";
  String CASE_NOT_REVIEWED_CODE = "ATF051";
  String CASE_NOT_REVIEWED_T = "xcm.altester.case.not.reviewed.t";
  String CASE_CAN_NOT_REVIEWED_T = "xcm.altester.case.can.not.reviewed.t";
  String CASE_REVIEW_REPEATED_T = "xcm.altester.case.review.is.repeated.t";

  /*<******************Case#Favourite(ATF071 ~ ATS075)******************>*/
  String CASE_FAVOURITE_REPEATED_T = "xcm.altester.case.favorite.repeated.t";
  /*<******************Case#Follow(ATF076 ~ ATS080)******************>*/
  String CASE_FOLLOW_REPEATED_T = "xcm.altester.case.follow.repeated.t";
