...
import static cloud.xcan.sdf.api.commonlink.TesterConstant.ALIYUN_BANDWIDTH_CHARGE_TYPE;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.ALIYUN_DESTINATION_RESOURCE;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.ALIYUN_INSTANCE_CHARGE_TYPE;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.ALIYUN_REGION_IDS;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.ALIYUN_RESOURCE_TYPE;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.DEFAULT_SYSTEMDISK_CATEGORY;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_IMAGE_ID;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_TYPE_16C_32G;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_TYPE_32C_64G;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_TYPE_4C_8G;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_TYPE_64C_128G;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_TYPE_8C_16G;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.INSTANCE_TYPE_MINI;
import static cloud.xcan.sdf.api.commonlink.TesterConstant.NODE_HOSTNAME_BID_KEY;
...
public class AliyunEcsClient implements EcsClient {
    ...
    return response.getBody().getInstances().getInstance().stream()
        .map(instance -> {
          ...
          node.setInstanceId(instance.getInstanceId())
              ...
              .setSyncFlag(StringUtils.isNotEmpty(node.getIp()));
          return node;
  ...
  private RunInstancesRequest getStartNodesRequest(String regionId, String hostname, Long orderId,
    ...
    RunInstancesRequest runInstancesRequest = new RunInstancesRequest()
        ...
        .setPassword(TesterConstant.NODE_PASSD_SALT + orderId)
        .setInstanceType(hostSpecToInstanceType(spec));
