...
import static cloud.xcan.sdf.api.commonlink.setting.quota.QuotaResource.AngusTesterModule;
...
public class ModuleQueryImpl implements ModuleQuery {
  ...
  public List<Module> find(GenericSpecification<Module> spec) {
    return new BizTemplate<List<Module>>() {
      ...
      protected List<Module> process() {
        ...
        setEditPermissionFlag(spec.getCriterias(), allModules);
        return allModules;
      }
    }.execute();
  }
  ...
  @Override
  public void setEditPermissionFlag(Set<SearchCriteria> criteria, List<Module> allModules) {
