...
@DoInFuture("Implementing OAS3 SwaggerXmlExampleGenerator with reference to swagger 2")
public class SwaggerXmlExampleGenerator {

  protected final Logger LOGGER = LoggerFactory.getLogger(SwaggerXmlExampleGenerator.class);
  ...
  public SwaggerXmlExampleGenerator(Map<String, Model> examples) {
  ...
  protected String modelImplToXml(ModelImpl model, int indent, Collection<String> path) {
    ...
    if (model.getProperties() != null) {
      for (String pName : model.getProperties().keySet()) {
        ...
        if (p != null && p.getXml() != null && p.getXml().getAttribute() != null && p.getXml()
            .getAttribute()) {
  ...
  protected String toXml(String name, Property property, int indent, Collection<String> path) {
    ...
    if (property instanceof ArrayProperty) {
      ...
      if (property.getXml() != null && property.getXml().getWrapped() != null && property.getXml()
          .getWrapped()) {
        wrapped = true;
      }
      if (wrapped) {
   ...
   * <p>
   * If an example value was not provided in the spec, a default will be generated.
   *
