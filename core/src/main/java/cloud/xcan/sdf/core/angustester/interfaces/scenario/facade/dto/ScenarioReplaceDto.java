...
public class ScenarioReplaceDto {
  ...
  @ApiModelProperty("Modify scenario id. Create a new scenario when the value is null")
  private Long id;

  @ApiModelProperty(value = "Project id, required when creating a new scenario")
