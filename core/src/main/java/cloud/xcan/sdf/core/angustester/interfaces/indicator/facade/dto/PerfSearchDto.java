...
public class PerfSearchDto extends PageQuery {
  ...
  @ApiModelProperty(value = "Required when app administrators query all performance indicator")
  ...
  @ApiModelProperty(value = "Performance indicator creator id")
  private Long createdBy;

  @ApiModelProperty(value = "Performance indicator creation time")
