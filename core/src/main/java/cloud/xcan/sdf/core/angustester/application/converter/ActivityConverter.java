...
public class ActivityConverter {
  ...
  public static Activity toActivity(CombinedTargetType targetType, ActivityType activityType,
      Object... params) {
    Principal principal = PrincipalContext.get();
    Long tenantId = nonNull(principal.getTenantId()) ? principal.getTenantId() : -1L;
    Activity activity = createActivity(targetType, null, activityType, principal, params);
  ...
  public static Activity toModifyTaskActivity(boolean replaceFlag, boolean hasModifyAssigness,
    ...
    if (nonNull(task.getMissingBugFlag()) && !task.getMissingBugFlag()
        .equals(taskDb.getMissingBugFlag())) {
      activity.append("<br/>").append(message(
          task.getMissingBugFlag() ? ActivityType.MISSING_BUG_SET.getDescMessageKey()
    ...
    if (hasModifyAssigness) {
      if (nonNull(task.getAssigneeId())) {
        ...
        if (replaceFlag && nonNull(taskDb.getAssigneeId())) {
          activity.append("<br/>").append(message(
    ...
    if (hasModifyConfirmors) {
      if (nonNull(task.getConfirmorId())) {
        ...
        if (replaceFlag && nonNull(taskDb.getConfirmorId())) {
          activity.append("<br/>").append(message(
    ...
    if (hasModifyTags) {
      if (isNotEmpty(task.getTagTargets())) {
        ...
        if (replaceFlag && isEmpty(task.getTagTargets()) && isNotEmpty(taskDb.getTagTargets())) {
          activity.append("<br/>").append(message(
    ...
    if (isNotEmpty(task.getDeadlineDate())
      ...
      if (replaceFlag && isEmpty(task.getDeadlineDate()) && isNotEmpty(taskDb.getDeadlineDate())) {
        activity.append("<br/>").append(message(
    ...
    if (hasModifyAttachments) {
      if (isNotEmpty(task.getAttachments())) {
        ...
        if (replaceFlag && isEmpty(task.getAttachments()) && isNotEmpty(taskDb.getAttachments())) {
          activity.append("<br/>").append(message(
    ...
    if (isNotEmpty(task.getEvalWorkload())
      ...
      if (replaceFlag && isNull(task.getEvalWorkload()) && nonNull(taskDb.getEvalWorkload())) {
        activity.append("<br/>").append(message(
    ...
    if (isNotEmpty(task.getActualWorkload())
      ...
      if (replaceFlag && isNull(task.getActualWorkload()) && nonNull(taskDb.getActualWorkload())) {
        activity.append("<br/>").append(message(
    ...
    if (isNotEmpty(task.getDescription())
      ...
      if (replaceFlag && isEmpty(task.getDescription()) && isNotEmpty(taskDb.getDescription())) {
        activity.append("<br/>").append(message(
    ...
    if (hasModRefTasks) {
      if (isNotEmpty(task.getRefTaskIds())) {
        ...
        if (replaceFlag && isEmpty(task.getRefTaskIds()) && isNotEmpty(taskDb.getRefTaskIds())) {
    ...
    if (hasModRefCases) {
      if (isNotEmpty(task.getRefCaseIds())) {
        ...
        if (replaceFlag && isEmpty(task.getRefCaseIds()) && isNotEmpty(taskDb.getRefCaseIds())) {
