...
import cloud.xcan.sdf.web.validator.annotations.Version;
...
public class ReportReplaceDto {
  ...
  @ApiModelProperty("Modify report id. Create a new report when the value is null")
  private Long id;

  @ApiModelProperty(value = "Project id, required when creating a new report")
