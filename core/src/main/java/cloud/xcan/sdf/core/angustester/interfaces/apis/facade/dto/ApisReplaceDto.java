...
public class ApisReplaceDto {
  ...
  @ApiModelProperty(example = "1", value = "Apis id")
  private Long id;
   ...
   */
  @NotBlank
  @ApiModelProperty(example = "Add user api", required = true)
  ...
  @ApiModelProperty(notes = "A declaration of which security mechanisms can be used for this apis.")
