...
import static cloud.xcan.sdf.core.angustester.application.converter.ApisConverter.toSchemaApis;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.SERVICE_NO_IMPORT_APIS_PLUGIN_CODE;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.SERVICE_NO_IMPORT_APIS_PLUGIN_T;
...
import static io.swagger.v3.oas.models.OpenAPIUtils.getExtensionLong;
...
import cloud.xcan.sdf.core.angustester.application.converter.ServicesCompConverter;
...
import cloud.xcan.sdf.core.angustester.domain.services.schema.ServicesSchemaRepo;
...
import io.swagger.v3.oas.models.OpenAPIUtils;
...
public class ServicesSchemaQueryImpl implements ServicesSchemaQuery {
  ...
  public ApisParseProvider checkAndGetApisParseProvider(ApiImportSource importSource) {
    ...
    if (isNull(enabledApisParseProvider)) {
      ...
      throw CommSysException.of(SERVICE_NO_IMPORT_APIS_PLUGIN_CODE,
