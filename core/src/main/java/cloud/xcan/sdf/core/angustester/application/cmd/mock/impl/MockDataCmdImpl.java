...
import static cloud.xcan.sdf.api.message.CommProtocolException.M.EXPRESSION_PARSING_ERROR_T;
import static cloud.xcan.sdf.core.angustester.application.converter.MockDataConverter.toAngusScript;
...
public class MockDataCmdImpl implements MockDataCmd {
    ...
    return new BizTemplate<String>() {
      ...
      protected String process() {
        ...
        try {
          ...
          throw CommProtocolException.of("Script format error, reason: " + getRootCauseMessage(e));
        }
      }
    }.execute();
  }
  ...
  public List<Object> mockFunc0(int iterations, String mockFunc) {
    try {
      ...
      throw CommProtocolException.of(EXPRESSION_PARSING_ERROR_T, new Object[]{mockFunc});
    }
  }
  ...
  private List<String> mockText0(int iterations, String text) {
    try {
      ...
      throw CommProtocolException.of(EXPRESSION_PARSING_ERROR_T, new Object[]{text});
    }
  }
