...
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.APIS_CASE_DEFAULT_NAME;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.APIS_CASE_SECURITY_NAME;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.APIS_CASE_SMOKE_NAME;
import static cloud.xcan.sdf.core.angustester.infra.util.AngusTesterUtils.assembleSecurityCaseAssertion;
import static cloud.xcan.sdf.core.angustester.infra.util.AngusTesterUtils.assembleSmokeCaseAssertion;
import static cloud.xcan.sdf.core.spring.SpringContextHolder.getBean;
import static cloud.xcan.sdf.spec.utils.JsonUtils.JSON;
...
public class ApisToAngusModelConverter {
  ...
  public static void assembleAddApisScript(Apis apisDb, Map<String, Server> serverMap,
    ...
    script.setAuthFlag(nullSafe(script.getAuthFlag(), false));
