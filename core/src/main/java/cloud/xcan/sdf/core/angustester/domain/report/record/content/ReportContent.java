...
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.APIS_TESTING_RESULT;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.EXECUTION_SAMPLING_RESULT;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.FUNC_TESTING_CASE;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.FUNC_TESTING_PLAN;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.OBJECT;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.PROJECT_PROGRESS;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.SCENARIO_TESTING_RESULT;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.SERVICES_TESTING_RESULT;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.TASK;
import static cloud.xcan.sdf.core.angustester.domain.report.record.content.ReportContent.TASK_SPRINT;
