...
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.MOCK_APIS_RESPONSE_ID_INCONSISTENT_T;
    ...
    new BizTemplate<Void>() {
      ...
      protected void checkParams() {
        ...
        if (isNotEmpty(subApisResponses)) {
          throw CommProtocolException.of(MOCK_APIS_RESPONSE_ID_INCONSISTENT_T);
        }
