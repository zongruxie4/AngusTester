...
public class ApisConverter {
  ...
  public static Apis toCloneApis(Apis apisDb, Services serviceDb) {
    return new Apis().setProjectId(apisDb.getProjectId())
        ...
        .setServiceAuthFlag(serviceDb.getAuthFlag())
        .setSecurityFlag(apisDb.getSecurityFlag())
        .setTestFuncFlag(apisDb.getTestFuncFlag())
        .setTestFuncPassedFlag(apisDb.getTestFuncPassedFlag())
        .setTestFuncFailureMessage(apisDb.getTestFuncFailureMessage())
        .setTestPerfFlag(apisDb.getTestPerfFlag())
        .setTestPerfPassedFlag(apisDb.getTestPerfPassedFlag())
        .setTestPerfFailureMessage(apisDb.getTestPerfFailureMessage())
        .setTestStabilityFlag(apisDb.getTestStabilityFlag())
        .setTestStabilityPassedFlag(apisDb.getTestStabilityPassedFlag())
        .setTestStabilityFailureMessage(apisDb.getTestStabilityFailureMessage())
        .setFollowFlag(apisDb.getFollowFlag())
      ...
      for (Apis apisDb : updateApisDbs) {
        if (apisDb.getId().equals(api.getId())) {
          api.setProjectId(apisDb.getProjectId())
              ...
              .setAuthFlag(apisDb.getAuthFlag())
              .setServiceAuthFlag(apisDb.getServiceAuthFlag())
              //.setSecurityFlag(apisDb.getSecurityFlag())
              ...
              .setServiceDeletedFlag(apisDb.getServiceDeletedFlag())
              .setDeletedFlag(apisDb.getDeletedFlag())
  ...
  public static ApisBasicInfo objectArrToApis(Object[] objects) {
    ApisBasicInfo apis = new ApisBasicInfo().setId(convert(objects[0], Long.class))
        ...
        .setServiceAuthFlag(convert(objects[5], Boolean.class))
    ...
    apis.setTestFuncFlag(convert(objects[19], Boolean.class))
        .setTestFuncPassedFlag(convert(objects[20], Boolean.class))
        .setTestFuncFailureMessage(convert(objects[21], String.class));
    apis.setTestPerfFlag(convert(objects[22], Boolean.class))
        .setTestPerfPassedFlag(convert(objects[23], Boolean.class))
        .setTestPerfFailureMessage(convert(objects[24], String.class));
    apis.setTestStabilityFlag(convert(objects[25], Boolean.class))
        .setTestStabilityPassedFlag(convert(objects[26], Boolean.class))
  ...
  public static void assembleApiAuthInfo(Apis api, Services projectDb) {
    api.setAuthFlag(nonNull(api.getAuthFlag()) ? api.getAuthFlag() : projectDb.getAuthFlag());
    api.setServiceAuthFlag(projectDb.getAuthFlag());
    if (isJobOrDoorApi()) {
  ...
  public static Apis assembleSchemaToAddApis(Apis apis, Services serviceDb,
    ...
    return apis.setSource(apiSource)
        ...
        .setServiceAuthFlag(serviceDb.getAuthFlag())
        .setSecurityFlag(nonNull(apis.getSecurity()))
        .setTestFuncFlag(true)
        .setTestPerfFlag(true)
        .setTestStabilityFlag(true)
  ...
  public static Set<SearchCriteria> getApisResourcesStatsFilter(Long projectId, Long serviceId,
    ...
    filters.add(equal("serviceDeletedFlag", false));
    return filters;
  }
