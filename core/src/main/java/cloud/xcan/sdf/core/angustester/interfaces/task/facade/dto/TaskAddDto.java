...
public class TaskAddDto {
  ...
  @ApiModelProperty(value = "Project id. It is required to create a backlog", example = "1")
  private Long projectId;

  //@NotNull
  @ApiModelProperty(value = "Sprint Id. Note: If the value is empty, it will be created as a Backlog", example = "1"/*, required = true*/)
  ...
  @ApiModelProperty(value = "Task name", example = "A task", required = true)
  private String name;
  ...
  @NotNull
  @ApiModelProperty(value = "Task type", example = "TASK", required = true)
  ...
  @ApiModelProperty(example = "FUNCTIONAL")
