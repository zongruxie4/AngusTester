...
import static cloud.xcan.sdf.core.angustester.application.converter.ApisConverter.countCreationApis;
import static cloud.xcan.sdf.core.angustester.application.converter.ApisConverter.countCreationService;
import static cloud.xcan.sdf.core.angustester.application.converter.ApisConverter.countCreationUnarchivedApis;
import static cloud.xcan.sdf.core.angustester.application.converter.ApisConverter.toApisDetailSummary;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.APIS_OPERATION_EXISTED;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.APIS_PUBLISHED_CANNOT_MODIFY_CODE;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.APIS_PUBLISHED_CANNOT_MODIFY_T;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.TRASH_NO_VIEW_PERMISSION;
import static cloud.xcan.sdf.core.angustester.domain.TesterCoreMessage.TRASH_NO_VIEW_PERMISSION_CODE;
import static cloud.xcan.sdf.core.angustester.domain.TesterEventMessage.ApisModification;
import static cloud.xcan.sdf.core.angustester.domain.TesterEventMessage.ApisModificationCode;
...
import static cloud.xcan.sdf.spec.utils.RegexpUtils.matches;
...
import cloud.xcan.sdf.core.angustester.domain.mock.apis.MockApisAssocP;
...
public class ApisQueryImpl implements ApisQuery {
  ...
  @Override
  public Apis detail(Long id, Boolean resolveRefFlag) {
    return new BizTemplate<Apis>() {
      ...
      protected Apis process() {
        ...
        BizAssert.assertTrue(!apisDb.getDeletedFlag() || apisDb.getDeletedBy().equals(getUserId()),
        ...
        if (Objects.equals(resolveRefFlag, true)) {
    ...
    return new BizTemplate<MockApis>() {
      ...
      protected MockApis process() {
        ...
        if (!Objects.equals(apisDb.getEndpoint(), mockApis.getEndpoint()) ||
          ...
          mockApis.setInconsistentOperationFlag(true)
              .setEndpoint(apisDb.getEndpoint()).setMethod(apisDb.getMethod());
        } else {
          mockApis.setInconsistentOperationFlag(false);
        }
  ...
  @Override
  public List<Apis> listDetail(HashSet<Long> ids, Boolean resolveRefFlag) {
    return new BizTemplate<List<Apis>>() {
      ...
      protected List<Apis> process() {
        // Set OpenAPI ref models
        if (isNotEmpty(apisDb) && Objects.equals(resolveRefFlag, true)) {
  ...
  public ApisResourcesCreationCount creationStatistics(Long projectId,
    ...
    return new BizTemplate<ApisResourcesCreationCount>() {
      ...
      protected ApisResourcesCreationCount process() {
        ...
        // Count services
        Set<SearchCriteria> serviceFilters = merge(commonFilters, equal("deletedFlag", false));
  ...
  public Boolean isAuthCtrl(Long id) {
    ...
    return nonNull(apis) && (apis.getServiceAuthFlag() && apis.getAuthFlag());
  }
  ...
  public void checkServiceApisOperationNotExisted(Collection<Apis> apis, Collection<Apis> apisDb,
    ...
    if (isNotEmpty(updateApis) && !replaceFlag /*Update apis*/) {
